...
class Commande
{
    ...
    public function create($trans_id,$amount,$date_debut,$date_fin,$offre_id,$nom,$lieu,$tel,$mail,$qte,$prod,$opera)
    {
        // Enregister la ligne pour la première fois
        if ($opera=='client') {
            // Paiement achat client
            saveAchat($trans_id,$amount,$nom,$lieu,$tel,$mail,$qte,$prod);
          }else{
            //Paiement Abonnement
            savePay($trans_id,$amount,$date_debut,$date_fin,$offre_id);
          }
