<nav class="navbar navbar-light navbar-glass navbar-top sticky-kit navbar-expand">
            ...
            <a class="navbar-brand mr-1 mr-sm-3" href="/">
              <div class="d-flex align-items-center">
                <span class="text-sans-serif text-warning">Immover</span>
              </div>
            </a>
            ...
            <ul class="navbar-nav navbar-nav-icons ml-auto flex-row align-items-center">
              ...
              <li class="nav-item dropdown dropdown-on-hover"><a class="nav-link pr-0" id="navbarDropdownUser" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <div class="avatar avatar-xl">
                    <img class="rounded-circle" src="assets/img/team/lograpid.png" alt="" />
                  </div>
                </a>
                <div class="dropdown-menu dropdown-menu-right py-0" aria-labelledby="navbarDropdownUser">
                  <div class="bg-white rounded-soft py-2">
                    ...
                    <div class="dropdown-divider"></div>
                      <a class="dropdown-item" href="https://www.vename.com/clientarea.php" target="_blank">Serveur</a>
                      <div class="dropdown-divider"></div>
                      <a class="dropdown-item" href="https://cinetpay.com/" target="_blank">CinetPay</a>
                      <div class="dropdown-divider"></div>
                      <a class="dropdown-item" href="logoutadmin">Quitter</a>
                  </div>
                </div>
              </li>
            </ul>
