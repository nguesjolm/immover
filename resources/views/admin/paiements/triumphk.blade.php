...
<div class="card bg-light mb-3">
  <div class="card-body p-3">
      ...
      </a>, Veuillez consulter l'Historique des paiements au compte Triumph-K</strong>
      </p>
  </div>
</div>
...
<div class="card mb-3">
    ...
    <div class="card-header">
     <h5 class="mb-0">Triumph-K Solde (1000 Fcfa/Visite)  => <b class="text-success">{{formatPrice(SoldTriumphk())}} Fcfa</b></h5>
    </div>
    ...
    <div class="card-body bg-light px-0">
     <table class="table table-sm table-dashboard data-table no-wrap mb-0 fs--1 w-100">
      <thead class="bg-200">
        <tr>
          <th class="sort">Triumph-K</th>
          <th class="sort">Infos</th>
          <th class="sort">Visites</th>
      ...
      <tbody class="bg-white">
       ...
       <tr>
         <td>Mme. ARMANDE</td>
         <td>Mobile Money : 07 88 89 26 08</td>
         <td>{{formatPrice(visiteTriumphk())}}</td>
         <td>{{formatPrice(SoldTriumphk())}} Fcfa</td>
         <td>
            <a href="triumphkSold">
