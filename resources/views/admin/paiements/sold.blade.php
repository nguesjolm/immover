...
<div class="card bg-light mb-3">
  <div class="card-body p-3">
      ...
      </a>, Veuillez consulter l'Historique des paiements au compte LogRapid</strong>
      </p>
  </div>
</div>
...
<div class="card mb-3">
    ...
    <div class="card-header">
     <h5 class="mb-0">LogRapid Solde (1000 Fcfa/Visite)  => <b class="text-success">{{formatPrice(SoldeLog())}} Fcfa</b></h5>
    </div>
     ...
     <table class="table table-sm table-dashboard data-table no-wrap mb-0 fs--1 w-100">
      ...
      <tbody class="bg-white">
       ...
       <tr>
         ...
         <td>{{formatPrice(VisiteLog())}}</td>
         <td>{{formatPrice(SoldeLog())}} Fcfa</td>
         <td>
            <a href="logRapidSold">
