...
<div class="card mb-3">
    ...
    <div class="card-header">
     <h5 class="mb-0">Demandes inactives  => <b class="text-success">{{count(DemandeAll(1))}} alertes</b></h5>
    </div>
    ...
    <div class="card-body bg-light px-0">
     <table class="table table-sm table-dashboard data-table no-wrap mb-0 fs--1 w-100">
      ...
      @foreach(DemandeAll(1) as $demand)
       <tr>
