...
<div class="card bg-light mb-3">
  <div class="card-body p-3">
      ...
      </a>,Nouvelles Publication</strong>
      </p>
  </div>
</div>
...
<div class="card mb-3">
    <div class="card-header">
     <h5 class="mb-0"><a href="newDemand">Retour ></a>Mise à jour avant Publication </h5>
    </div>
    
    <form action="pubAdd" method="get">
        <div class="card-body bg-light px-0">
          <div class="form-group" style="margin-left:5%;margin-right:5%">
            <label for="example">Code: {{ReadDemndID($Demnd)->codes}} / Client :  {{ReadDemndID($Demnd)->whatsap}}</label>
            <textarea name="moreP" class="form-control" id="example" rows="3">{{ReadDemndID($Demnd)->more}}</textarea>
          </div>
          <input type="hidden" value="{{$Demnd}}" name="demandID">
        </div>

        <div class="card-footer">
         <button style="margin-bottom:5%" class="ml-1 btn col-lg-2 btn-primary rounded-capsule mr-1 mb-1" type="submit">PUBLIER</button>     
        </div>
    </form>
