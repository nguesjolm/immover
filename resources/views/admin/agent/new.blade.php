...
<div class="card bg-light mb-3">
  <div class="card-body p-3">
      ...
      </a>: Démarcheur / Agences immobilière agrées , Veuillez remplir le formulaire pour créer un Agent</strong>
      </p>
  </div>
</div>
...
<div class="card mb-3">
            <div class="card-header">
              <h5 class="mb-0">Nouveau Agent LogRapid</h5>
            </div>
              ...
              <div class="row">
                <div class="col-12">
                    ...
                    <form>
                        ...
                        <!-- Agent LogRapid -->
                        <div class="form-group">
                         <label for="statut">Statut (Démarcheur/Agence)</label>
                         <input class="form-control" name="statut" id="statut" type="text" required>
                        </div>
