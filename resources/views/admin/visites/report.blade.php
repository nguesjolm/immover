...
<div class="card bg-light mb-3">
  <div class="card-body p-3">
      ...
      </a>,Historique des visites reportées</strong>
      </p>
  </div>
</div>
...
<div class="card mb-3">
    ...
    <div class="card-header">
     <h5 class="mb-0">Visites  => <b class="text-success"> {{count(AllVisites(1))}} Visites reportées</b></h5>
    </div>
    ...
    <div class="card-body bg-light px-0">
     <table class="table table-sm table-dashboard data-table no-wrap mb-0 fs--1 w-100">
      ...
      <tbody class="bg-white">
       @foreach(AllVisites(1) as $visite)
        <tr>
          ...
          <td>
              ...
              <a href="visiteAnnul?id={{$visite->idbiensclient}}&&url=reportVisites&&idbiens={{$visite->idbiens}}">
                <span class="badge badge-pill badge-danger">
                Annuler
                </span>
              </a>

              <a href="visiteEffect?id={{$visite->idbiensclient}}&&url=reportVisites&&idbiens={{$visite->idbiens}}">
