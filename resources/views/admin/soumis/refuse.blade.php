...
<div class="card bg-light mb-3">
  <div class="card-body p-3">
      ...
      </a>,Historique des  soumissions refusées</strong>
      </p>
  </div>
</div>
...
<div class="card mb-3">
    ...
    <div class="card-header">
     <h5 class="mb-0">Biens  => <b class="text-success">{{count(ReadBiensoumisStat(2))}} soumissions refusées</b></h5>
    </div>
    ...
    <div class="card-body bg-light px-0">
     <table class="table table-sm table-dashboard data-table no-wrap mb-0 fs--1 w-100">
      ...
      <tbody class="bg-white">
        ...
        @foreach(ReadBiensoumisStat(2) as $soumis)
          <tr>
