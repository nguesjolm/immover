...
<div class="card bg-light mb-3">
  <div class="card-body p-3">
      ...
      </a>,Historique des biens indisponibles</strong>
      </p>
  </div>
</div>
...
<div class="card mb-3">
    ...
    <div class="card-header">
     <h5 class="mb-0">Biens  => <b class="text-success">{{count(Allbiens(1))}} biens indispos</b></h5>
    </div>
    ...
    <div class="card-body bg-light px-0">
     <table class="table table-sm table-dashboard data-table no-wrap mb-0 fs--1 w-100">
      ...
      @foreach(Allbiens(1) as $biens)
       <tr>
          <td><b>Code: {{$biens->codebiens}} - </b>{{$biens->libele}}</td>
          ...
          <td>
              <a href="DelBiens?id={{$biens->idbiens}}&&url=indispBiens">
                <span class="badge badge-pill badge-danger">
                Supprimer
                </span>
              </a>

              <a href="bienSold?biens={{$biens->idbiens}}&&act=2">
