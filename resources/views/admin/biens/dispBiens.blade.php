...
<div class="card bg-light mb-3">
  <div class="card-body p-3">
      ...
      </a>,Historique des biens disponibles</strong>
      </p>
  </div>
</div>
...
<div class="card mb-3">
    ...
    <div class="card-header">
     <h5 class="mb-0">Biens  => <b class="text-success">{{count(Allbiens(0))}} biens dispos</b></h5>
    </div>
    ...
    <div class="card-body bg-light px-0">
     <table class="table table-sm table-dashboard data-table no-wrap mb-0 fs--1 w-100">
      ...
      @foreach(Allbiens(0) as $biens)
       <tr>
          <td>{{$biens->created_at}}<br>
          <b>Code: {{$biens->codebiens}} <br>  </b>{{$biens->libele}}</td>
          ...
          <td>
              ...
              <a href="bienSold?biens={{$biens->idbiens}}&&act=1">
                <span class="badge badge-pill badge-primary">
               Indispo
                </span>
              </a>

              <a href="single?biens={{$biens->idbiens}}&act=1">
                <span class="badge badge-pill badge-info">
                Détails
                </span>
              </a>

              <a href="updBiens?biens={{$biens->idbiens}}&act=1">
