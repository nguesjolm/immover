...
<div class="card mb-3">
            <div class="card-header">
              <h5 class="mb-0">Nouvelles opérations</h5>
            </div>
                ...
                <div class="col-12">
                    <form>
                        ...
                        <div class="form-group">
                         ...
                         <input class="form-control" name="operations" id="operations" type="text" required>
                        </div>
...
<div class="card mb-3">
    ...
    <div class="card-header">
     <h5 class="mb-0">Opérations immobilières  => <b class="text-success">{{count(ReadOpera())}}  Opérations</b></h5>
    </div>
      ...
      <tbody class="bg-white">
        @foreach(ReadOpera() as $opera)
         <tr>
           ...
           <td>{{operaBiens($opera->idtypesoperations)}} Biens</td>
           <td>
              <a href="operatypesDel?id={{$opera->idtypesoperations}}">
