            ...
            <div class="card-body bg-light">
              <div class="row">
                <div class="col-12">
                    ...
                    <form action="AddBiens" method="post" enctype="multipart/form-data">
                        @csrf
                        <!-- Types d'opérations -->
                          ...
                          <div class="custom-file col-lg-6">
                           ...
                           <input class="form-control" name="files[]" type="file" multiple="multiple"  required>
                            ...
                            <!-- <div class="form-group col-3">
                                ...
                                <input class="form-control" name="img1" id="img1" type="file" required>
                            </div> -->
                        ...
                        <button class="btn btn-primary mb-3 send" type="submit">Ajouter</button>
