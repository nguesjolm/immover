...
<div class="card bg-light mb-3">
  <div class="card-body p-3">
      ...
      </a>, Localisation Pays - Villes </strong>
      </p>
  </div>
</div>
<div>
                ...
                <div class="col-12">
                    ...
                    <form>
                        ...
                        <div class="form-group">
                         ...
                         <input type="hidden" id="paySelected">
                        </div>

                        <button class="btn btn-danger mb-3 Addvile" type="button">Lier</button>
                        ...
                        <div class="form-group">
                         ...
                         <input class="form-control pays" id="pays" type="text">
                        </div>
                        
                        <button class="btn btn-primary mb-3 newPays" type="button">Ajouter</button>
...
<div class="card mb-3">
    ...
    <div class="card-header">
     <h5 class="mb-0">Historique des villes  => <b class="text-success">{{count(ReadVille())}} villes</b></h5>
    </div>
     ...
     <table class="table table-sm table-dashboard data-table no-wrap mb-0 fs--1 w-100">
      ...
      <tbody class="bg-white">
       ...
       @foreach(ReadVille() as $ville)
        <tr>
           <td>{{$ville->ville}}</td>
           <td>{{ReadpaysId($ville->pays_idpays)->pays}}</td>
           <td>{{villesbiens($ville->idvilles)}} Biens</td>
           <td>
              <a href="DelVille?id={{$ville->idvilles}}">
