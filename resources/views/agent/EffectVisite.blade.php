...
<div class="card mb-3">
    ...
    <div class="card-header">
     <h5 class="mb-0"><span class="text-danger">Visites Effectuées</span>  => <b> {{count(VisiteAgent($_SESSION['agentCD'],3))}} </b></h5>
    </div>
    ...
    <div class="card-body bg-light px-0">
     <table class="table table-sm table-dashboard data-table no-wrap mb-0 fs--1 w-100">
      ...
      <tbody class="bg-white">
       @foreach(VisiteAgent($_SESSION['agentCD'],3) as $visite)
        <tr>
