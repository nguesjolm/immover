...
<div class="card bg-light mb-3">
  <div class="card-body p-3">
      <p class="fs--1 mb-0"><a href="#!">
        ...
        <a href="agentcount"><span class="badge badge-warning"><span class='fas fa-home'></span> Dashboard</span></a>
        <a href="NewvisiteAg"><span class="badge badge-primary">Nouvelle({{count(VisiteAgent($_SESSION['agentCD'],0))}})</span></a>
        <a href="EffectVisiteAg"><span class="badge badge-danger">Effectuées({{count(VisiteAgent($_SESSION['agentCD'],3))}})</span></a>
        <a href="SoldVisiteAg"><span class="badge badge-success">Soldées({{count(visiteRecouv(0,4,$_SESSION['agentCD']))}})</span></a>
        <a href="RecouVisiteAg"><span class="badge badge-info">Recouvertes({{count(visiteRecouv(1,4,$_SESSION['agentCD']))}})</span></a>
      </p>
  </div>
</div>
...
<div class="card mb-3">
    ...
    <div class="card-header">
     <h5 class="mb-0"><span class="text-success">Visites Recouvertes</span>  => <b> {{count(visiteRecouv(1,4,$_SESSION['agentCD']))}} </b></h5>
    </div>
    ...
    <div class="card-body bg-light px-0">
     <table class="table table-sm table-dashboard data-table no-wrap mb-0 fs--1 w-100">
      ...
      <tbody class="bg-white">
       @foreach(visiteRecouv(0,4,$_SESSION['agentCD']) as $visite)
        <tr>
