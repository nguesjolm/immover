            ...
            <div class="offcanvas offcanvas-start offcanvas-collapse" id="filters-sidebar">
              ...
              <div class="offcanvas-header d-block border-bottom pt-0 pt-lg-4 px-lg-0">
                <ul class="nav nav-tabs mb-0">
                  ...
                  <li class="nav-item"><a class="nav-link active" href="buy"><i class="fi-home fs-base me-2"></i>Achat</a></li>
                </ul>
              </div>
          ...
          <div class="col-lg-8 col-xl-9 position-relative overflow-hidden pb-5 pt-4 px-3 px-xl-4 px-xxl-5">
            ...
            <nav class="mb-3 pt-md-2" aria-label="Breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Achat de biens immobilier</li>
              </ol>
            </nav>
            <!-- Title-->
            ...
            <div class="row g-4 py-4 produitFilt">
             @if(count(AllbiensOpera(9))!=0)
              <?php foreach(AllbiensOpera(9) as $biens) { ?>
                <!-- Item-->
             ...
             <div class="alert alert-primary" role="alert">
                Aucun biens immobiliers disponible pour Achat
              </div>
             @endif
