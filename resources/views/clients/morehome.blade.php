        ...
        <div class="row g-0 mt-n3">
            ...
            <div class="offcanvas offcanvas-start offcanvas-collapse" id="filters-sidebar">
              ...
              <div class="offcanvas-header d-block border-bottom pt-0 pt-lg-4 px-lg-0">
                <!-- <ul class="nav nav-tabs mb-0">
                  <li class="nav-item"><a class="nav-link" href="locate"><i class="fi-rent fs-base me-2"></i>Location</a></li>
                  <li class="nav-item"><a class="nav-link" href="buy"><i class="fi-home fs-base me-2"></i>Achat</a></li>
                </ul> -->

                <div class="mb-3">
                  <h3 class="h6">Type d'operation</h3>
                  <select class="form-control form-select" id="OperaR">
                    <option value='0'>Choisir</option>
                    <option value="8">Je veux louer</option>
                    <option value="9">Je veux acheter</option>
                  </select>
                  <input type="hidden" class="operaFiltR">
                </div>
              </div>
          ...
          <div class="col-lg-8 col-xl-9 position-relative overflow-hidden pb-5 pt-4 px-3 px-xl-4 px-xxl-5">
            ...
            <nav class="mb-3 pt-md-2" aria-label="Breadcrumb">
              <ol class="breadcrumb">
                <!-- <li class="breadcrumb-item"><a href="/">LogRapid</a></li>
                ...
                <!-- <a class="btn btn-sm btn-outline-success rounded-pill" 
                   href="#cost-calculator" data-bs-toggle="modal">
                 <i class="fi-download me-2"></i>Soumettre une demande
                </a> -->

                <!-- <a class="btn btn-sm btn-outline-warning rounded-pill" href="demandes"><i class="fi-grid me-2"></i>Voir les demandes</a> -->

                <!--<a  class="btn btn-sm btn-outline-primary rounded-pill"-->
                <!--    href="#givebiens" data-bs-toggle="modal">-->
                ...
                <a  class="btn btn-sm btn-outline-success rounded-pill" href="#alert-immo" data-bs-toggle="modal">
                  <!-- <i class="fi-download"></i>--> Une demande ? 
                </a>
            ...
            <div class="d-flex flex-sm-row flex-column align-items-sm-center align-items-stretch my-2">
              ...
              <div class="form-floating mb-3 col-lg-6">
                ...
                <label for="floating-input">Que cherchez-vous ?</label>
            ...
            <div class="row g-4 py-4 produitFilt">
              ...
              <?php foreach(AllbiensLimit(0) as $biens) { ?>
                <!-- Item-->
                  ...
                  <div class="card shadow-sm card-hover border-0 h-100">
                    ...
                    <div class="tns-carousel-wrapper card-img-top card-img-hover"><a class="img-overlay" href="#"></a>
                      ...
                      <div class="tns-carousel-inner">
                        <img src="{{$biens->img2}}" alt="Image" style="width:612px;height:400px;">
                        <img src="{{$biens->img1}}" alt="Image" style="width:612px;height:400px;">
                      </div>
                    </div>
              ...
              <div class="alert alert-danger" role="alert">
                 Nous disposons de plus de {{count(Allbiens(0))}} biens en ce moment. Cliquer en bas sur le boutton filtrer  pour trouver votre bien
              </div>
