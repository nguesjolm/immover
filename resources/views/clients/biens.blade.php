            ...
            <div class="row g-4 py-4 produitFilt">
                  ...
                  <div class="card shadow-sm card-hover border-0 h-100">
                    <div class="tns-carousel-wrapper card-img-top card-img-hover"><a class="img-overlay" href="#"></a>
                      ...
                      <div class="tns-carousel-inner">
						...
						<img src="{{$biens->img4}}" alt="Image">
						<img src="{{$biens->img5}}" alt="Image">
						<img src="{{$biens->img6}}" alt="Image">
						<img src="{{$biens->img7}}" alt="Image">
						<img src="{{$biens->img8}}" alt="Image">
                      </div>
                    </div>
              ...
              @else
                 <div class="alert alert-primary" role="alert">
                    Aucun biens de cette catégorie n'est disponible
                 </div>
              @endif
