...
<div class="card bg-light mb-3">
  <div class="card-body p-3">
      <p class="fs--1 mb-0"><a href="#!">
        ...
        <a href="BiensG"><span class="badge badge-primary">Biens dispo</span></a>
        <a href="bienIndispoG"><span class="badge badge-danger">Biens indispo</span></a>
      </p>
  </div>
</div>
...
<div class="card mb-3">
    ...
    <div class="card-header">
     <h5 class="mb-0">Biens indisponibles => <b class="text-success">{{count(BiensGerant($_SESSION['gerantID'],1))}} biens indispos</b></h5>
    </div>
    ...
    <div class="card-body bg-light px-0">
     <table class="table table-sm table-dashboard data-table no-wrap mb-0 fs--1 w-100">
      ...
      @foreach(BiensGerant($_SESSION['gerantID'],1) as $biens)
       <tr>
          ...
          <td>
              ...
              <a href="bienSoldG?biens={{$biens->idbiens}}&&act=2">
                <span class="badge badge-pill badge-danger">
                 Dispo
                </span>
              </a>
