...
<div class="card mb-3">
            <div class="card-header">
             <a class="mb-0" href="BiensG"><= Retour :</a> {{ReadBiensID($idbiens)->libele}}</b>
            </div>
                ...
                <div class="col-12">
                    ...
                    <form action="UpdBienSelect" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                         ...
                         <input type='hidden' name='gerant' value='{{ReadBiensID($idbiens)->gerants_idgerant}}'>
                        ...
                        <input type='hidden' name='url' value='BiensG'>
