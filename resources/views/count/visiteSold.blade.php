...
<div class="container mt-5 mb-md-4 py-5">
        ...
        <div class="card card-body p-4 p-md-5 shadow-sm">
          ...
          <div class="mt-md-n3 mb-4"><a class="btn btn-outline-primary btn-lg rounded-pill w-100 d-md-none" href="#account-nav" data-bs-toggle="collapse"><i class="fi-align-justify me-2"></i>Menu</a>
            <div class="collapse d-md-block" id="account-nav">
              ...
              <li class="nav-item mb-md-0 me-md-2 pe-md-1"><a class="nav-link" href="count"><i class="fi-user mt-n1 me-2 fs-base"></i> Mon Compte</a></li>
                ...
                <li class="nav-item mb-md-0 me-md-2 pe-md-1"><a class="nav-link active" href="visitesSold"><i class="fi-wallet mt-n1 me-2 fs-base"></i> Visite Soldée ({{count(AllVisiteClient($_SESSION['clientID'],4))}})</a></li>
          ...
          <div class="alert alert-primary" role="alert">
             <i class="fi-check-circle mt-n1 me-2 fs-base"></i> Visites Soldées({{count(AllVisiteClient($_SESSION['clientID'],4))}})
           </div>
          
          @if(count(AllVisiteClient($_SESSION['clientID'],4))!=0)
          <!-- Favorites grid-->
          <div class="row row-cols-lg-3 row-cols-sm-2 row-cols-1 gy-4 gx-3 gx-lg-4">
            <?php foreach (AllVisiteClient($_SESSION['clientID'],4) as $visite) { ?>
            <!-- Item-->
            <div class="col pt-2">
              <div class="position-relative">
                <div class="position-relative mb-3">
                  <button class="btn btn-icon btn-primary btn-xs text-white rounded-circle position-absolute top-0 end-0 m-3 zindex-5" type="button" data-bs-toggle="tooltip" data-bs-placement="left" title="Remove from Favorites"><i class="fi-check-circle"></i></button><img class="rounded-3" src="img/real-estate/catalog/03.jpg" alt="Article img">
                </div>
                ...
                <span class="badge rounded-pill bg-success">Soldée</span>
              </div>
            </div>
            <?php } ?>
          </div>
